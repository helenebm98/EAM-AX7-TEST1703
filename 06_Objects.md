...
![Figure 6-13](/Figures/06-13_EAM_Parameters_Form-02_AX7_v1712A.png)
...
![Figure 6-17](/Figures/06-17_EAM_Parameters_Form-06_AX7_v1712.png)
...
![Figure 6-25](/Figures/06-25_Planning_Notes_DetailView.png)
...
![Figure 6-26](/Figures/06-26_WorkerGroups_Form_AX7-01.png)
...
![Figure 6-27](/Figures/06-27_Objects_List_ASM_AX7_v1810.png)
...
![Figure 6-28](/Figures/06-28_Object_Form_AX7_v1810.png)
...
3. In the **Create object** dialog, insert data regarding **Object** (the object ID) and the object name. Select date and time for the object in the **Effective** field. From that date, you are able to install the object on a functional location as well as move and replace the object in an object hierarchy.
...
If you add a customer to an object that has child objects, it is possible to copy customer information to the child objects.
...
![Figure 6-29](/Figures/06-29_Object_Form_AX7_v1810.png)
